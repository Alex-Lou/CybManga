// ============================================
// SumiWire PRO - Interaction du canvas (hook)
// Centering, raccourcis clavier, panning, drag de pages, zoom molette.
// Possède l'état/refs/effets ; retourne ce dont le rendu a besoin.
// ============================================
...
export const useCanvasInteraction = ({ state, dispatch, currentPage }) => {
