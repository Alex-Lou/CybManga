// ============================================
// SumiWire PRO - Moteur de dessin interactif (hook)
// Multi-canvas (baked + active), handlers pointeur, bake des strokes,
// outils single-click / two-phase / screentone. Refs partagées = un seul hook.
// ============================================
...
export const useDrawingPointer = ({ state, dispatch, currentPage, pageWidth, pageHeight }) => {
